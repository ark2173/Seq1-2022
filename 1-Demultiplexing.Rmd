...
rm(list = ls())
library(Seurat)
HashID<-read.csv('F:/Data/Sequencing/Files/DONOTDELETE-HashingCode.csv',row.names = 1)
```

# Loading

```{r Run1}
Raw <- Read10X(data.dir = "D:/RawData/SequencingData/CellRangerOuts/EA001/filtered_feature_bc_matrix")
...
```{r Run2}
Raw <- Read10X(data.dir = "F:/Data/Sequencing/CellRangerOuts/EA002/filtered_feature_bc_matrix")
